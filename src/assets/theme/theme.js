...
export const FONTS = {
  ...
  primarytext1: 'Montserrat-Regular',
  primarytext2: 'Montserrat-Bold',
  primarytext3: 'Montserrat-Medium',
  primarytext4: 'Montserrat-Light',
  primarytext5: 'Montserrat-SemiBold',
